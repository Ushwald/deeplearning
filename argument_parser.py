...
def setup_argument_parser():
    ...
    parser.add_argument("--elu", help = "Hidden layer activation function", type = bool, default = False)
    parser.add_argument("--sgdm", help = "Specified optimizer algorithm", type = bool, default = False)
